import ResumeMobile from "../mobilePages/ResumeMobile";
              ...
              <div className="col-6">
                <Paper elevation={10} sx={{ backgroundColor: grey[300] }}>
                  <p style={{ margin: 20 }}>
                    ...
                    I've worked a part time job since I graduated high school as
                    I worked towards my degree. I've worked a customer service
                    job as a cashier and sales clerk as well as physically
                    demanding shipping and receiving jobs.
                    <br></br> <br></br>I am currently beginning work as an
                    independant contractor where I have mostly dealt with
                    analyzing how well an ai handles prompts related to Python
                    code.
                    <br></br> <br></br>{" "}
                  </p>
                </Paper>
                      ...
                      <p style={{ margin: 20 }}>
                        ...
                        <ul>
                          ...
                          <li>
                            ...
                            - I am very confident in my ability to find
                            reasonable conclusions and articulate said
                          ...
                          <li>
                            <strong>Optimization</strong> - I always am trying
                            to work out the most efficient and effective way for
                            the team to do tasks.
                          </li>
                          <li>
