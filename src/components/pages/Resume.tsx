                ...
                <Paper elevation={10} sx={{ backgroundColor: grey[300] }}>
                  <p style={{ margin: 20 }}>
                    ...
                    <ul>
                      ...
                      <li>
                        <strong>Informative and Persuasive Writing</strong> - I
                        am very confident in my ability to find reasonable
                      ...
                      <li>
                        <strong>Project Leadership</strong> - I often defaulted
                        to team lead in my course projects for my inititive in
                        putting forth ideas.
                      </li>
                      <li>
                        <strong>Informal Workplace Leadership</strong> -
                        Coworkers often look for me to make calls when there are
